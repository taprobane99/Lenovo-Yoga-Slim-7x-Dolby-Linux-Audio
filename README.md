...
This project also upmixes the sound to use all 4 speakers on the Slim 7x. This laptop has two full range speakers either side of the keyboard deck ("Rear"), and two tweeters under the front ("Front"). Only the tweeters are enabled by default.
